...
@section('content')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <form action="{{ route('home') }}" method="GET" class="banner-search-form">
                            <svg style="width:18px;height:18px;color:rgba(255,255,255,0.8);flex-shrink:0;" fill="none"
                ...
                <div class="col-lg-6">
                    <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                            ...
                            <a href="{{ $sudahTerdaftarSorot ? route('dashboard') : route('event.show', $sorot['id']) }}" class="event-card-sd d-block"
                                ...
                                <div class="event-body">
                                    ...
                                    <div class="event-meta">
                                        <span>
                                            <svg style="width:14px;height:14px;" fill="none" stroke="currentColor"
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M17.7 16.7 13.4 21a2 2 0 0 1-2.8 0l-4.3-4.3a8 8 0 1 1 11.4 0Z" />
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="event-footer">
                                        <div>
                                            <small style="font-size:11px;color:#6b7280;display:block;font-weight:500;">Mulai
                                                dari</small>
                                            <span
                                                style="font-size:17px;font-weight:700;color:{{ (int) ($sorot['harga'] ?? 0) === 0 ? '#16a34a' : '#111827' }};">
                        ...
                        @else
                            <img src="{{ asset('vendor/space-dynamic/images/banner-right-image.png') }}"
                                alt="SeTiket Events">
                        @endif
                    </div>
                </div>
            ...
            <div class="container" style="margin-top:30px;">
                <div class="greeting-card wow fadeIn d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3"
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div
                            style="width:44px;height:44px;border-radius:12px;background:#eff6ff;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            <svg style="width:22px;height:22px;color:#2563eb;" fill="none" stroke="currentColor"
                        ...
                        <div>
                            ...
                            <p style="font-size:14px;color:#6b7280;margin:0;">
                                @if ($myTicketCount > 0)
                                    {{ $myTicketCount }} tiket aktif.
                                @endif
                                @if ($myPendingOrders > 0)
                                    {{ $myPendingOrders }} pesanan menunggu verifikasi.
                                @endif
                            </p>
                        </div>
                    </div>
            ...
            <div class="section-heading mb-5 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s">
                @if (!empty($q))
                    ...
                    <p>
                        ...
                        <a href="{{ route('home') }}"
                            style="color:#2563eb;font-size:14px;font-weight:500;margin-left:8px;">← Tampilkan semua</a>
                    </p>
                @else
            ...
            <div class="row g-4">
                @forelse($upcomingEvents as $ev)
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s"
                        data-wow-delay="{{ 0.2 + ($loop->index % 2) * 0.15 }}s">
                        <article class="event-card-h event-card"
                            ...
                            <a href="{{ route('event.show', $ev['id']) }}" class="thumb">
                                ...
                                @if ($sudahTerdaftar)
                                    <span class="badge"
                                        style="position:absolute;top:10px;left:10px;background:#22c55e;color:#fff;">
                                        ✓ Terdaftar
                                    </span>
                                @endif
                            </a>
                            ...
                            <div class="body">
                                <div class="d-flex gap-2 mb-2" style="flex-wrap:wrap;">
                                    ...
                                    @if ($gratis)
                                        <span class="badge" style="background:#f0fdf4;color:#16a34a;">Gratis</span>
                                    @endif
                                </div>
                                ...
                                <div class="footer">
                                    <div>
                                        <small style="font-size:11px;color:#6b7280;display:block;font-weight:500;">Mulai
                                            dari</small>
                                        <span
                                            style="font-size:16px;font-weight:700;color:{{ $gratis ? '#16a34a' : '#111827' }};">
                                            {{ $gratis ? 'Gratis' : 'Rp' . number_format($ev['harga'], 0, ',', '.') }}
                                        </span>
                                    </div>
                                    @php 
                                        $isClosed = $ev['is_closed'] ?? false; 
                                    ...
                                    <a href="{{ $sudahTerdaftar ? route('dashboard') : route('event.show', $ev['id']) }}"
                                        ...
                                        @if(($isClosed || $isPrivate) && !$sudahTerdaftar) style="background: #9ca3af; color: white; border-color: #9ca3af; cursor: not-allowed;" @endif>
                                        @if ($sudahTerdaftar)
                                            Lihat Pesanan
                                        @elseif($isPrivate)
                                            Private
                ...
                @empty
                    <div class="col-12" style="text-align:center;padding:60px 0;">
                        @if (!empty($q))
                            <svg style="width:56px;height:56px;color:#d1d5db;margin:0 auto 16px;display:block;"
                                fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="m21 21-4.35-4.35M17 11a6 6 0 1 1-12 0 6 6 0 0 1 12 0Z" />
                            </svg>
                            <p style="color:#374151;font-weight:600;font-size:16px;margin:0 0 8px;">Event tidak ditemukan
                            </p>
                            <p style="color:#6b7280;margin:0 0 20px;">Tidak ada event yang cocok dengan
                                <strong>"{{ $q }}"</strong>.</p>
                            <a href="{{ route('home') }}" class="btn-ticket-cta" style="text-decoration:none;">← Lihat
                                Semua Event</a>
                        @else
                                ...
                                <span>
                                    <span class="phone-icon">
                                        <svg style="width:18px;height:18px;" fill="none" stroke="currentColor"
                                            stroke-width="2" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M2 6.5C2 14.5 9.5 22 17.5 22c.66 0 1.3-.05 1.93-.13A1 1 0 0 0 20 21v-3.28a1 1 0 0 0-.75-.97l-3.28-.82a1 1 0 0 0-1.04.38l-.97 1.4a15.06 15.06 0 0 1-6.67-6.67l1.4-.97a1 1 0 0 0 .38-1.04l-.82-3.28A1 1 0 0 0 7.28 5H4a2 2 0 0 0-2 1.5Z" />
                                        </svg>
                                    </span>
                ...
                <div class="col-lg-5 mt-5 mt-lg-0 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
                    <div style="background:#fff;border-radius:20px;padding:48px 36px;position:relative;">
                        ...
                        <div style="display:flex;flex-direction:column;gap:12px;">
                            <a href="{{ route('home') }}#events" class="btn-ticket-cta"
                                style="width:100%;padding:13px 24px;font-size:15px;">
                                Jelajahi Semua Event
                            </a>
                            @guest
                                <a href="{{ route('register') }}" class="btn-ticket-registered"
                                    style="width:100%;padding:12px 24px;font-size:14px;border:1.5px solid #2563eb;color:#2563eb;background:#eff6ff;">
                                    Buat Akun Gratis
                                </a>
                            @endguest
                        </div>
    ...
    @push('scripts')
        <script>
            ...
            (function() {
                const inputs = [document.getElementById('navbarSearch'), document.getElementById('navbarSearchMobile')]
                    .filter(Boolean);
                ...
                inputs.forEach(input => {
                    ...
                    input.addEventListener('keypress', function(e) {
                        if (e.key === 'Enter' && !document.querySelector('.event-card')) {
                            window.location.href = '{{ route('home') }}?q=' + encodeURIComponent(this
                                .value);
                        }
                    });
                });
