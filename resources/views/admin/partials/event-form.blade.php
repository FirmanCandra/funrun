...
<div>
    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Thumbnail Event
        (JPG/PNG/WebP, maks 1MB)</label>
...
<div class="flex items-center gap-2 mt-4">
    <input type="checkbox" name="is_closed" value="1" id="add_is_closed"
...
<div class="flex items-center gap-2 mt-2 mb-2">
    <input type="checkbox" name="is_private" value="1" id="add_is_private"
        class="rounded border-slate-300 text-blue-600 focus:ring-blue-500 w-4 h-4">
    <label for="add_is_private" class="text-sm font-semibold text-slate-700 cursor-pointer">
...
<div class="mt-4 border-t border-slate-100 pt-4">
    ...
    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 text-sm text-blue-800">
        ...
        <div class="text-xs text-blue-700 mt-1">Event baru wajib diberi minimal satu rekening sebelum tiketnya bisa
            dibeli.</div>
    </div>
</div>
